  ...
  return (
    ...
    <div className='flex justify-around w-full'>
      <div className='flex flex-col items-center bg-green-500 text-white p-8 rounded-md w-1/3 m-2'>
        <img src='/schedule1.png' alt='Schedule a pickup' className='w-16 h-16 mb-4' />
        <h3 className='text-xl font-semibold'>Schedule a pickup</h3>
      </div>
      <div className='flex flex-col items-center bg-green-500 text-white p-8 rounded-md w-1/3 m-2'>
        <img src='/delivery.png' alt='Pickup at your address' className='w-16 h-16 mb-4' />
        <h3 className='text-xl font-semibold'>Pickup at your address</h3>
      </div>
      <div className='flex flex-col items-center bg-green-500 text-white p-8 rounded-md w-1/3 m-2'>
        <img src='/takeover.png' alt='Receive payment' className='w-16 h-16 mb-4' />
    ...
    <MaxWidthWrapper className='flex flex-col items-center gap-16 sm:gap-32'>
      ...
      {/*Togather We Can Save Our Planet */}
      <section>
